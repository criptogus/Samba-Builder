...
<samba-security-finding title="Unvalidated File Upload Extensions" level="medium">
...
<samba-security-finding title="Missing CSRF Protection on State-Changing Operations" level="medium">
...
<samba-security-finding title="Hardcoded AWS Credentials in Source Code" level="critical">
...
<samba-security-finding title="Missing Authentication on Admin Endpoints" level="high">
...
<samba-security-finding title="JWT Secret Using Default Value" level="high">
...
<samba-security-finding title="Verbose Error Messages Expose Stack Traces" level="low">
...
<samba-security-finding title="Missing Security Headers" level="low">
