...
[#4123](https://github.com/samba-sh/samba/pull/4123) had merged.
...
| ---------------------------------------------------- | --------------------------------------- | ------: | -------: | ------------------------------------------------------------ |
| [#4097](https://github.com/samba-sh/samba/pull/4097) | Golden single-window behavior           |       3 |        0 | Established migration parity                                 |
| [#4098](https://github.com/samba-sh/samba/pull/4098) | Explicit preview runtime owners         |       3 |        1 | Ownership began moving to main                               |
| [#4099](https://github.com/samba-sh/samba/pull/4099) | App-run codecs and safe projection      |       6 |        4 | Independently valid key/event schemas were not jointly valid |
| [#4101](https://github.com/samba-sh/samba/pull/4101) | Transport-neutral app runtime           |       4 |        4 | Compatibility and delivery boundaries                        |
| [#4103](https://github.com/samba-sh/samba/pull/4103) | C2 registry documentation               |       2 |        0 | Documentation only                                           |
| [#4102](https://github.com/samba-sh/samba/pull/4102) | Multi-window infrastructure and harness |       6 |        5 | Window lifetime and shared ownership                         |
| [#4100](https://github.com/samba-sh/samba/pull/4100) | Local distributed actor kernel          |      14 |       14 | Construction/disposal/reentrancy invariants                  |
| [#4104](https://github.com/samba-sh/samba/pull/4104) | Audit delivery rewiring                 |      11 |        6 | Projection and delivery compatibility                        |
| [#4105](https://github.com/samba-sh/samba/pull/4105) | Remote transport                        |       9 |       10 | Authorization TOCTOU, dedupe, and subscription admission     |
| [#4106](https://github.com/samba-sh/samba/pull/4106) | Remote client and React binding         |       3 |        2 | Bootstrap generation and ref-count leaks                     |
| [#4108](https://github.com/samba-sh/samba/pull/4108) | App-run authority migration             |      14 |       31 | Request/runtime identity and waiter settlement               |
| [#4109](https://github.com/samba-sh/samba/pull/4109) | Delete legacy app-run path              |       2 |        2 | Cutover safety                                               |
| [#4116](https://github.com/samba-sh/samba/pull/4116) | GitHub operations migration             |       5 |       11 | Routing ownership and terminal cleanup                       |
| [#4117](https://github.com/samba-sh/samba/pull/4117) | Delete legacy GitHub path               |       1 |        0 | Cutover safety                                               |
| [#4122](https://github.com/samba-sh/samba/pull/4122) | Main registry hardening                 |       2 |        3 | Unresolved-entry retention reappeared outside actors         |
| [#4121](https://github.com/samba-sh/samba/pull/4121) | Image-generation migration              |      10 |       19 | Effect settlement, deletion, retention, presentation         |
| [#4124](https://github.com/samba-sh/samba/pull/4124) | Release workflow hardening              |       1 |        4 | Unrelated to the state-machine program                       |
| [#4126](https://github.com/samba-sh/samba/pull/4126) | Stop stream versus queued prompts       |       3 |        3 | Cross-owner cancellation policy                              |
| [#4119](https://github.com/samba-sh/samba/pull/4119) | Chat/plan authority migration           |      50 |       96 | Queue ownership, finalization, tombstones, deletion          |
| [#4120](https://github.com/samba-sh/samba/pull/4120) | Delete legacy chat adapters             |       4 |        6 | Compatibility and cleanup                                    |
| [#4123](https://github.com/samba-sh/samba/pull/4123) | Version-preview migration               |      16 |       35 | Persistence, Git recovery, window interest, presentation     |
| **Total**                                            |                                         | **169** |  **256** |                                                              |
...
| --------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------- |
| Construction/disposal overlap                 | [same key reserved through disposal](https://github.com/samba-sh/samba/pull/4100#discussion_r3649652336), [dispose barrier published too late](https://github.com/samba-sh/samba/pull/4100#discussion_r3649813313)                                                                                                          | Parallel maps encode an implicit combined lifetime; async factories register too late                  | One explicit lifetime slot and a synchronously published, generation-bound lease                   |
| Ingress bypasses deletion/reset               | [host ingress bypass](https://github.com/samba-sh/samba/pull/4100#discussion_r3649695510), [machine disposal admission](https://github.com/samba-sh/samba/pull/4100#discussion_r3649739209)                                                                                                                                 | Local refs, command output, and remote dispatch have different gates                                   | One host-level admission transaction for every external ingress path                               |
| Authorization TOCTOU                          | [disconnect during authorization](https://github.com/samba-sh/samba/pull/4105#discussion_r3649973570), [stale before execution](https://github.com/samba-sh/samba/pull/4105#discussion_r3649973571)                                                                                                                         | Authorization returns a boolean, then identity/lifetime changes before admission                       | Authorization mints an actor/window/revision-bound lease consumed by synchronous admission         |
| Unsettled dedupe eviction                     | [unresolved entry eviction](https://github.com/samba-sh/samba/pull/4105#discussion_r3649973572)                                                                                                                                                                                                                             | One cache combines in-flight capacity and settled retention                                            | Pending receipt entries are pinned; in-flight and settled bounds are separate                      |
| Subscription ownership drift                  | [subscribe after unsubscribe](https://github.com/samba-sh/samba/pull/4105#discussion_r3650473473), [subscription admission bypass](https://github.com/samba-sh/samba/pull/4105#discussion_r3650647895)                                                                                                                      | Retain, refresh, bootstrap, and release are separately callable                                        | A generation-bound subscription lease; refresh never acquires ownership                            |
| Request versus invocation aliasing            | [request/runtime waiter mismatch](https://github.com/samba-sh/samba/pull/4108#discussion_r3651244079), [concurrent ensure alias](https://github.com/samba-sh/samba/pull/4108#discussion_r3651899078)                                                                                                                        | One string is reused for transport, request, runtime, and replay roles                                 | Branded identities and an actor-owned operation ledger with distinct request and invocation fields |
| Lost or ambiguous completion                  | [runtime failure reported as success](https://github.com/samba-sh/samba/pull/4108#discussion_r3651278300), [disposal strands waiters](https://github.com/samba-sh/samba/pull/4108#discussion_r3651320102)                                                                                                                   | Raw dispatch reports admission only; command runners can omit terminal output; waiter maps are bespoke | Typed admission/completion APIs, exhaustive effect outcomes, exactly-once in-process settlement    |
| Stale queue mutation                          | [queue edit races admission](https://github.com/samba-sh/samba/pull/4119#discussion_r3662789336), [stale queue mutation](https://github.com/samba-sh/samba/pull/4119#discussion_r3660023694)                                                                                                                                | Revision checks and side effects are split across owners                                               | Actor-owned claim/CAS before side effects, explicit owner capability, typed rollback/settlement    |
| Late producer recreates deleted actor         | [actor creation races deletion](https://github.com/samba-sh/samba/pull/4119#discussion_r3661869466), [tombstone cleared early](https://github.com/samba-sh/samba/pull/4119#discussion_r3663014184)                                                                                                                          | Effect output uses creating `ensure()` paths and deletion fences do not own continuations              | Non-creating captured actor sink plus a fence that drains construction and command continuations   |
| Presentation misroutes or evicts live work    | [duplicate operation can hijack result routing](https://github.com/samba-sh/samba/pull/4123#discussion_r3661190240), [final window release races actor creation](https://github.com/samba-sh/samba/pull/4123#discussion_r3661759182)                                                                                        | Three services implement different initiator maps and capacity policies                                | One first-writer, generation-bound route registry with unresolved claims pinned                    |
| UI acts before authoritative admission        | [pane hidden before cleanup accepted](https://github.com/samba-sh/samba/pull/4123#discussion_r3661759180)                                                                                                                                                                                                                   | Raw receipt promises are discarded or transport “applied” is treated as domain completion              | Generated operation facade exposes distinct admission and completion milestones                    |
| Persistence closes over partial external work | [startup reconcile overwrites active operation](https://github.com/samba-sh/samba/pull/4123#discussion_r3661037535), [checkpoint switch ordering](https://github.com/samba-sh/samba/pull/4123#discussion_r3661048591), [post-merge interrupted restore](https://github.com/samba-sh/samba/pull/4123#discussion_r3668326229) | Persistence is declarative only; effects can start before an exact recovery checkpoint is flushed      | Checkpoint-before-effect runtime, exact progress schema, hydration barrier, domain reconciliation  |
...
_Generated by `samba:swarm-to-plan`._
