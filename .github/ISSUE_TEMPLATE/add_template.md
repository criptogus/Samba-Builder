---
name: Add Template
about: Request to add a template to Samba Hub
title: "Add Template: [Template Name]"
labels: "add-template"
assignees: ""
---

If you'd like to add a template to Samba Hub, follow the [Add Template guide](https://samba.sh/docs/templates/add-template).
