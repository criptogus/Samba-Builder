...
Related: `npm run start:onboarding` launches the real app with fresh userData and `SAMBA_DEV_NODEJS_STATUS=missing` to reproduce first-run / Node-missing states.
