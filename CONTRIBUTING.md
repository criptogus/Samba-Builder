...
Before opening a pull request, please open an issue and discuss whether the change makes sense in Samba. Ensuring a cohesive user experience sometimes means we can't include every possible feature or we need to consider the long-term design of how we want to support a feature area.
...
Something that I really appreciate are all the non-code contributions, such as reporting bugs, writing feature requests and participating on [Samba's sub-reddit](https://www.reddit.com/r/sambabuilders).

## Development

Samba is an Electron app.
...
Samba relies on several AI code reviewers to catch issues. If a comment is irrelevant please leave a brief comment and mark the comment as resolved.
