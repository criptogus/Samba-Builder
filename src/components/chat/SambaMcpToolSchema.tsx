...
interface SambaMcpToolSchemaProps {
  children?: ReactNode;
  node?: {
...
export const SambaMcpToolSchema: React.FC<SambaMcpToolSchemaProps> = ({
  children,
  node,
}) => {
  ...
  return (
    ...
    >
      <SambaCardHeader icon={<ScrollText size={15} />} accentColor="indigo">
        <SambaBadge color="indigo">MCP Tool Schema</SambaBadge>
        {!isExpanded && tools && (
