...
import { SambaCard, SambaCardHeader } from "./SambaCardPrimitives";

interface SambaTokenSavingsProps {
  originalTokens: number;
  smartContextTokens: number;
}

export const SambaTokenSavings: React.FC<SambaTokenSavingsProps> = ({
  originalTokens,
  smartContextTokens,
}) => {
