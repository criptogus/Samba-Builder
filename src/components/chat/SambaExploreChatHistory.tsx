...
interface SambaExploreChatHistoryProps {
  children?: ReactNode;
  node?: {
    properties?: {
...
export const SambaExploreChatHistory: React.FC<
  SambaExploreChatHistoryProps
> = ({ children, node }) => {
  ...
  return (
    <SambaCard
      ...
      data-testid="samba-explore-chat-history"
    >
      <SambaCardHeader icon={<History size={15} />} accentColor="purple">
        <SambaBadge color="purple">{t("exploreChatHistory.badge")}</SambaBadge>
