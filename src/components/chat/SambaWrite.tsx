...
export const SambaWrite: React.FC<SambaWriteProps> = ({
  children,
  node,
  path: pathProp,
  ...
  return (
    ...
    >
      <SambaCardHeader icon={<Pencil size={15} />} accentColor="blue">
        ...
        {inProgress && (
          <SambaStateIndicator state="pending" pendingLabel="Writing..." />
        )}
        {aborted && (
