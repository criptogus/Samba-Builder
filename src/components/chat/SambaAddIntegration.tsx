...
import { getCompletedIntegrationProvider } from "./sambaAddIntegrationUtils";
import { ipc } from "@/ipc/types";
import { usePostHog } from "posthog-js/react";
import { captureIntegrationSetupStart } from "@/lib/integrationSetupTelemetry";

interface SambaAddIntegrationProps {
  children: React.ReactNode;
  provider?: "neon" | "supabase";
  outcome?: "pending" | "skipped" | "completed" | "dismissed";
}

export const SambaAddIntegration: React.FC<SambaAddIntegrationProps> = ({
  children,
  ...
  if (outcome === "skipped") {
    return (
      <SambaCard accentColor="slate" state="finished">
        <SambaCardHeader icon={<Database size={15} />} accentColor="slate">
          <SambaBadge color="slate">
  ...
  if (
    ...
    return (
      <SambaCard accentColor="green" state="finished">
        <SambaCardHeader icon={<CheckCircle2 size={15} />} accentColor="green">
          <SambaBadge color="green">
  ...
  return (
    <SambaCard accentColor="blue">
      <SambaCardHeader icon={<Database size={15} />} accentColor="blue">
        <SambaBadge color="blue">
