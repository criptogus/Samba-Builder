...
interface SambaGitProps {
  children?: ReactNode;
  node?: { properties?: SambaGitProperties };
}
...
export const SambaGit = ({ children, node }: SambaGitProps) => {
