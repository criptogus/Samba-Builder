...
export function SambaStepLimit({ node, children }: SambaStepLimitProps) {
  ...
  return (
    <SambaCard state={state} accentColor="amber" isExpanded={true}>
      <SambaCardHeader icon={<PauseCircle size={15} />} accentColor="amber">
      ...
      <SambaCardContent isExpanded={true}>
        {content && (
