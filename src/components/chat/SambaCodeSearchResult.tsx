...
interface SambaCodeSearchResultProps {
  node?: any;
  children?: React.ReactNode;
}

export const SambaCodeSearchResult: React.FC<SambaCodeSearchResultProps> = ({
  children,
}) => {
  ...
  return (
    ...
    >
      <SambaCardHeader icon={<FileCode size={15} />} accentColor="indigo">
        <SambaBadge color="indigo">Code Search Result</SambaBadge>
        {files.length > 0 && (
