...
export const SambaScript: React.FC<SambaScriptProps> = ({ node, children }) => {
  ...
  return (
    <SambaCard
      ...
      data-testid="samba-script-card"
    >
      <SambaCardHeader icon={<ScrollText size={15} />} accentColor="amber">
        <SambaBadge color="amber">Script</SambaBadge>
