...
interface SambaMcpToolCallProps {
  node?: any;
...
export const SambaMcpToolCall: React.FC<SambaMcpToolCallProps> = ({
  node,
  children,
  resultContent,
  state,
  ...
  return (
    ...
    >
      <SambaCardHeader icon={<Wrench size={15} />} accentColor="blue">
        <SambaBadge color="blue">{merged ? "Tool" : "Tool Call"}</SambaBadge>
        {serverName && (
