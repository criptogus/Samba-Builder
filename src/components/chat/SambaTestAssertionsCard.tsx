...
/**
 * The `<samba-test-assertions>` tag as it appears in the transcript: a receipt,
 * not a control.
 *
...
interface SambaTestAssertionsCardProps {
  node: {
    properties: {
      "proposal-id"?: string;
      "request-id"?: string;
...
function ReceiptShell({ children }: { children: React.ReactNode }) {
  return (
    <div
      ...
      data-testid="samba-test-assertions-receipt"
    >
...
export const SambaTestAssertionsCard: React.FC<
  SambaTestAssertionsCardProps
> = ({ node, children }) => {
    ...
    return (
      <ReceiptShell>
        ...
        <span
          ...
          data-testid="samba-test-assertions-approved-badge"
        >
