...
export const PROMO_MESSAGES: PromoMessageConfig[] = [
  {
    id: "pro-trial",
    text: "Build more with Samba Builder — free for 7 days.",
  ...
  {
    id: "agent-mode",
    text: "Let Samba Builder fix bugs with Agent mode.",
    cta: "Get Samba Builder",
    target: { type: "trial-dialog" },
    weight: 3,
  },
  {
  ...
  {
    id: "speech-to-text",
    text: "Tired of typing? Talk to Samba Builder with your voice.",
    cta: "Get Samba Builder",
    target: { type: "trial-dialog" },
    weight: 3,
  },
  {
    id: "web-search",
    text: "Let Samba Builder use the web for fresh information and better builds.",
    cta: "Get Samba Builder",
    target: { type: "trial-dialog" },
    weight: 2,
  },
  {
    id: "pro-tools",
    text: "Recreate a website with Samba Builder.",
    cta: "Unlock Samba Builder",
    target: { type: "trial-dialog" },
    weight: 2,
  },
  {
  ...
  {
    id: "github-star",
    text: "Enjoying Samba Builder? Star us on GitHub.",
    cta: "Star on GitHub",
