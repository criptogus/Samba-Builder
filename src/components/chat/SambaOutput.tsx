...
interface SambaOutputProps {
  type: "error" | "warning";
  message?: string;
  children?: React.ReactNode;
}

export const SambaOutput: React.FC<SambaOutputProps> = ({
  type,
  message,
  children,
}) => {
  ...
  return (
    ...
    >
      <SambaCardHeader icon={icon} accentColor={accentColor}>
        <SambaBadge color={accentColor}>{label}</SambaBadge>
        {message && (
