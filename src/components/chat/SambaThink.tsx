...
import { SambaTokenSavings } from "./SambaTokenSavings";

interface SambaThinkProps {
  node?: any;
  children?: React.ReactNode;
}

export const SambaThink: React.FC<SambaThinkProps> = ({ children, node }) => {
  ...
  const tokenSavingsMatch =
    typeof children === "string"
      ? children.match(
          /^samba-token-savings\?original-tokens=([0-9.]+)&smart-context-tokens=([0-9.]+)$/,
        )
      : null;
  ...
  // If it's token savings format, render SambaTokenSavings component
