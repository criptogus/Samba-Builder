...
interface SambaAddDependencyProps {
  children?: ReactNode;
  node?: any;
  packages?: string;
}

export const SambaAddDependency: React.FC<SambaAddDependencyProps> = ({
  children,
  node,
}) => {
  ...
  return (
    ...
    >
      <SambaCardHeader icon={<Package size={15} />} accentColor="blue">
        <SambaBadge color="blue">Add Packages</SambaBadge>
        {hasChildren && (
