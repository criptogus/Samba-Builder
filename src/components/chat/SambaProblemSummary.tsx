...
interface SambaProblemSummaryProps {
  summary?: string;
...
export const SambaProblemSummary: React.FC<SambaProblemSummaryProps> = ({
  summary,
  children,
}) => {
  ...
  return (
    ...
    >
      <SambaCardHeader icon={<AlertTriangle size={15} />} accentColor="amber">
        <SambaBadge color="amber">Auto-fix</SambaBadge>
