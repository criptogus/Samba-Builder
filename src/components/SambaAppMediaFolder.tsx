...
interface SambaAppMediaFolderProps {
  appName: string;
  appId: number;
  appPath: string;
  files: MediaFile[];
...
export function SambaAppMediaFolder({
  appName,
  appId,
  appPath,
  files,
  ...
  if (isOpen) {
    return (
      <>
        ...
        {previewFile && (
          <ImageLightbox
            imageUrl={buildSambaMediaUrl(appPath, previewFile.fileName)}
            alt={previewFile.fileName}
            filePath={`${appPath}/.samba/media/${previewFile.fileName}`}
