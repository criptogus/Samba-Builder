...
export const SETTING_IDS = {
  ...
  autoOpenPullRequest: "setting-auto-open-pull-request",
...
export const SETTINGS_SEARCH_INDEX: SearchableSettingItem[] = [
  ...
  {
    id: SETTING_IDS.autoOpenPullRequest,
    label: "Open a pull request after every push",
    description:
      "Push a branch and have Samba Builder open the pull request against the repository's default branch",
    keywords: [
      "github",
      "pull request",
      "pr",
