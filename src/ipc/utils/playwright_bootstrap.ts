 ...
 */
const DYAD_CONFIG_SENTINEL = "Generated by Samba Builder";
...
// ${DYAD_CONFIG_SENTINEL}. The dev server is started separately by Samba Builder's
...
export function buildPreviewShimSource(): string {
  return `// ${DYAD_CONFIG_SENTINEL}. Do not edit — Samba Builder regenerates this file.
//
...
export function buildE2eTsconfigSource(appPath: string): string {
  ...
  return `${JSON.stringify(
    {
      _comment: `${DYAD_CONFIG_SENTINEL}. Routes @playwright/test through Samba Builder's fixture shim so tests can run inside the preview panel. The other entries keep this app's own tsconfig settings, which this file would otherwise shadow. Delete this file to opt out.`,
