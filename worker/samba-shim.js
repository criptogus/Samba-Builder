(function () {
  console.debug("samba-shim.js loaded via proxy v0.6.0");
      ...
      if (url && typeof url === "string") {
        try {
          ...
          if (
            ...
            console.warn(
              "[samba-shim] Blocked navigation to unsafe URL protocol:",
              parsedUrl.protocol,
            );
          }
        } catch (e) {
          console.error("[samba-shim] Invalid navigation URL:", e);
        }
      } else if (url) {
        console.warn("[samba-shim] Invalid URL type:", typeof url);
      } else {
